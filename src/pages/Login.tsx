  ...
  return (
    <section className="min-h-screen flex items-center justify-center">
      <div className="container shadow-login-shadow rounded-xl p-8 w-[400px] m-auto mt-5 backdrop-blur-[20px] h-[70vh] items-center">
        <h2 className="text-center text-4xl text-[darkblue] font-extrabold tracking-wide">LOGIN</h2>
        
        <form onSubmit={handleSubmit} className="items-center m-auto text-center space-y-4">
          <div className="my-5">
            <label 
          ...
          <div className="flex justify-between px-5">
            <label className="flex items-center text-left font-bold text-[navy]" htmlFor="remember">
              <input 
                type="checkbox" 
                id="remember"
                name="remember"
