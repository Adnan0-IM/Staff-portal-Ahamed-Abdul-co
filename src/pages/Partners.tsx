...
const Partners = () => {
  ...
  const pendingReports = filteredReports.filter((r: Report) => r.status === 'pending');
  ...
  // Dynamic statistics
  const pendingCount = reports.filter((r: Report) => 
    r.status === 'pending' && 
  ...
  return (
    <div className="p-8 space-y-8 bg-gray-50">
      ...
      <div className="backdrop-blur-[1px] bg-white rounded-lg shadow-lg p-6">
        <h2 className="text-2xl font-bold text-[#052659] mb-4">Pending Reviews</h2>
        ...
        <div className="space-y-4">
          {pendingReports.length === 0 ? (
            <p className="text-center text-gray-500 py-4">No pending reports found</p>
          ) : (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-bold text-[navy] mb-4">Report Statistics</h2>
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="bg-yellow-100 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-yellow-600">{avgReviewTime}</p>
            </div>
          </div>
        </div>
